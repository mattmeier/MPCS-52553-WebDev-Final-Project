...
User.create(id: '4', name: 'Rick Andrews', email: 'andrews@harvard.edu', password: 'asda123sd', university_id: 3, graduation_year: 2014, major: 'Economics', bio: 'HARVARD IS STILL THE BEST', location_id: '9', interested_in_hosting: 'no', interested_in_hanging_out: 'yes')
User.create(id: '5', name: 'Jessica Sanchez', email: 'sanchez@stanford.edu', password: 'asg3ggg4g', university_id: 5, graduation_year: 2013, major: 'Electrical Engineering', bio: 'Up for going out in Vegas', location_id: '5', interested_in_hosting: 'yes', interested_in_hanging_out: 'yes')
...
Event.create(id: 1, name: 'Princeton Reunions', university_id: 4, location_id: 11, address: 'Main Campus', start_time: DateTime.new(2015,5,22,17), end_time: DateTime.new(2015,5,24,23), description: 'Reunions weekend attracts almost 25,000 alumni, family and friends for walks, talks, community service projects, Alumni-Faculty Forums, picnics, parties, concerts, dancing, meeting old friends, making new ones and, of course, marching in the One and Only P-rade! - See more at: http://alumni.princeton.edu/goinback/reunions/#sthash.JLm4qbYE.dpuf', organizer_contact_email: 'susie@princeton.edu')
Event.create(id: 2, name: 'UChicago Alumni Meetup', university_id: 1, location_id: 9, address: 'Scholars Inn, West Washington Street 44',  start_time: DateTime.new(2015,5,29,18), end_time: DateTime.new(2015,5,29,22), description: 'Dear Boston Alumni, we are happy to have an informal UChicago Alumni Meetup this May. We will meet at the Scholars Inn, as always! Looking forward!', organizer_contact_email: 'meierm@uchicago.edu')
Event.create(id: 3, name: 'Stanford Alumni Social', university_id: 5, location_id: 5, address: 'LV Brew House, McKinsey Ave 44', start_time: DateTime.new(2015,6,1,19), end_time: DateTime.new(2015,6,1,23), description: 'Monthly Alumni social at the Las Vegas Brew House. Friends and family are welcome to join!', organizer_contact_email: 'sanchez@stanford.edu')
Event.create(id: 4, name: 'Bulldogs in Dallas - Monthly Stammtisch', university_id: 6, location_id: 7, address: 'Tiger Inn, Boston Avenue and 44th Street', start_time: DateTime.new(2015,6,10,17), end_time: DateTime.new(2015,6,10,22), description: 'Join us for our monthly Stammtisch at the Tiger Inn!', organizer_contact_email: 'spiegel@yale.edu')
Event.create(id: 5, name: 'Annual Washington Harvard-Club Summer BBQ', university_id: 3, location_id: 4, address: 'tba', start_time: DateTime.new(2015,7,3,18), end_time: DateTime.new(2015,7,3,22), description: 'The annual summer BBQ is an established tradition of the Washington Harvard-Club and an event not to miss out. We will serve all sorts of meats, sausages and grilled veggies as well as a variety of soft drinks and cocktails. The location will be announced closer to the event!', organizer_contact_email: 'andrews@harvard.edu')
Event.create(id: 6, name: 'Columbia Alumni River Cruise', university_id: 7, location_id: 6, address: 'Details announced later!', start_time: DateTime.new(2015,7,22,16), end_time: DateTime.new(2015,7,22,19), description: 'Join us for an awesome river cruise. More details to be announced soon, but save the date!', organizer_contact_email: 'rl@columbia.edu')
Event.create(id: 7, name: 'Berkeley New York After-Work Meetup', university_id: 7, location_id: 2, address: 'The Professional Cocktail Bar, Rowley Street 44', start_time: DateTime.new(2015,7,1,19), end_time: DateTime.new(2015,7,1,22), description: 'Come along to our monthly after-work meetup. This is a great way to stay in touch with old Berkeley friends and meet alumni in the city.', organizer_contact_email: 'lesser@berkeley.edu')
