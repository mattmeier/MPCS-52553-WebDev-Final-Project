...
Event.create(id: 3, name: 'Stanford Alumni Social', university_id: 5, location_id: 5, start_time: DateTime.new(2015,6,1,19), end_time: DateTime.new(2015,6,1,23), description: 'Monthly Alumni social at the Las Vegas Brew House. Friends and family are welcome to join!', organizer_id: 5)
