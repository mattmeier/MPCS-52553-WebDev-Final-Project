...
Friendlist.create(id: '1', requester_id: 1, friend_id: 3)
Friendlist.create(id: '2', requester_id: 1, friend_id: 2)
Friendlist.create(id: '3', requester_id: 2, friend_id: 4)
Friendlist.create(id: '4', requester_id: 3, friend_id: 5)
Friendlist.create(id: '5', requester_id: 6, friend_id: 4)
Friendlist.create(id: '6', requester_id: 3, friend_id: 7)
Friendlist.create(id: '7', requester_id: 4, friend_id: 1)
Friendlist.create(id: '8', requester_id: 3, friend_id: 2)
Friendlist.create(id: '9', requester_id: 2, friend_id: 7)

Event.create(id: 1, name: 'Princeton Reunions', location_id:11, date: Date.new(2015, 05, 23), time: '18:00', description: 'Reunions weekend attracts almost 25,000 alumni, family and friends for walks, talks, community service projects, Alumni-Faculty Forums, picnics, parties, concerts, dancing, meeting old friends, making new ones and, of course, marching in the One and Only P-rade! - See more at: http://alumni.princeton.edu/goinback/reunions/#sthash.JLm4qbYE.dpuf', organizer_id: 8)
